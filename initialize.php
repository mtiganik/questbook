...
email VARCHAR(40),
ts TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
password VARCHAR(20), -- password on meil lahtiselt, mis p�ris rakenduses ei sobiks
PRIMARY KEY (username))"; // username on n��d alati unikaalne, kahte rida sama usernamega baas ei luba
